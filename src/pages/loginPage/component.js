...
export function FormInput(props) {
    ...
    return (
        <div style={{ paddingTop: '10px', width: props.width,}}>
            ...
            <input style={inputStyle} type={props.type} onChange={props.onChange} value={props.value} name={props.name} placeholder={props.placeholder} {...register(props.name,validation[props.name])} />
